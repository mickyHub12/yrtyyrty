...
from Gates.bulkmemorycards import BraintreeAuthWoo
...
def panel(_, message):
    ...
    comando_info = MongoClient().collection_cuatro.find_one({"comando": "/br"})
    
    if comando_info is None or comando_info.get('estado') != '✅':
        return message.reply(f"""
[ᚠ]𝑪𝒐𝒎𝒎𝒂𝒏𝒅: /br
[ᚠ]𝑭𝒐𝒓𝒎𝒂𝒕: /br 𝑪𝑪|𝑴𝑴|𝒀𝒀|𝑪𝑽𝑽
[ᚠ]𝑼𝒔𝒆 = 𝑷𝒓𝒆𝒎𝒊𝒖𝒎
[ᚠ]𝑮𝒂𝒕𝒆𝒘𝒂𝒚: Braintree Auth
[ᚠ]𝑺𝒕𝒂𝒕𝒖𝒔: OFF!❌
""")
